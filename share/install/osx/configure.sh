#!/usr/bin/env bash
#
# I'm goint to take my time and research what each change does before just 
# applying it to my system.  If I can get a reliable backup first, then I
# might be a little more experimental.
#
