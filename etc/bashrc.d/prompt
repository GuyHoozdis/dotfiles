# This prompt was straight ripped from Paul Irish's configuration.  I didn't
# even change anything.  I've been running with a really minimalistic prompt
# for a while, so I'm going to give this a whirl.  It might be worth while
# checking out airline/powerline again.  It's been a few years since I last
# tried them.  I really the look/feel of those packages, but they felt heavier
# than I preferred.


default_username='ssullivan'
