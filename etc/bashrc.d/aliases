...
# Homebrew
#
# !!!: I was doing this to prevent my key from getting acidentally captured in a crash 
# log / error report if I am ever debugging server code using dev/qa envioronment variables.
#
# Now that this is going into a public repo I can't put my key there anymore.  I need to rework
# the command - perhaps a function that reads the token from a file that doesn't get checked in.
